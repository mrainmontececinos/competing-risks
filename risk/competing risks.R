...
newdata<-data.frame(sex=factor(c("Hombre","Hombre","Female"),
                               levels=levels(Melanoma$sex)),age=c(50,31,29),
...
#### Zhang Análisis de supervivencia en presencia de riesgos competitivos
